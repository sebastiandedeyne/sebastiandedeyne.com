---
id: 86c90376-c929-42b2-8716-d3dd7c1d2b99
blueprint: post
...
_Use `vite --https` instead of `vite` in the `dev` script if you're serving your local app over HTTPS._
...
_If you used the `--https` option in the previous steps, these scripts will be served from `https://localhost:3000/` instead._
...
_This could go in a `helpers.php` file, learn how to set one up [here](https://laravel-news.com/creating-helpers)._
