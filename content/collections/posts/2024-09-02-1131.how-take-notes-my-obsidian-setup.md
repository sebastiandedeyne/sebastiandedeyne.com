...
Once I'm done with a note, it gets moved to the Archive folder with a date. For example, `Archive/2024/08/240830 Spatie.be Guidelines Redesign.md`. Having a date in the filename ensure I don't have any duplicates, and having them in the system in a separate folder means they're still easily searchable.

Here's an slice of my notes in Obsidian. I prefix the folder names with number to keep them sorted by actionability.
...
I have Obsidian configured to store any file attachments in `Archive/Attachments.md` to keep them out of view.
...
I often read posts of Obsidian scaring people off because of it's complexity. I disagree: with a few tweaks, you can set up a beautiful minimal note-taking environment.
